const Box = ({ icon, title, description }) => {
  return (
    <div className="relative md:w-[370px] w-[330px] font-montserrat md:h-[314px] h-[300px] rounded-[30px] border-[1px] bg-gradient-to-b from-[#1B3782] to-[#09173C] p-4 md:p-6 flex-3">
